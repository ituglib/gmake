...
#if (defined (butterfly) || defined (__arm) || (defined (__mips) && \
defined (_SYSTYPE_SVR3)) || (defined (sequent) && defined (i386)))
#undef POSIX
#endif
...
!defined (_POSIX_VERSION) && !defined(WINDOWS32)
...
/*===========================================================================*/
#pragma page "T0593 GUARDIAN GNU Make- wmakeh Change Descriptions"
/*===========================================================================*/

/*
------------------------------------------------------------------------------
Yosemite 04/01/02                                                 YODL:BLS0003
  - Modified include file inclusions, such that the addition
    of stdlib.h to smainc in support of get_assign_msg calls
    will not create a problem.
------------------------------------------------------------------------------
 End wmakeh change descriptions
*/
